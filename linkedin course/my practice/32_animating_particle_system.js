...
function update(renderer, scene, camera, controls) {
    ...
    //adding a little bit of rotation animation
    ...
    particleSystem.geometry.vertices.forEach(function(particle){
        ...
        //for not going out of the scene
        //reseting the particle positions
        if(particle.x < -50) {
            particle.x = 50;
        }
        if(particle.y < -50) {
    ...
    //for moving need to set it true
