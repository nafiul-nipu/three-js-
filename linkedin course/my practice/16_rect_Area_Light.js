//code doesnot work.. need to work later
...
function init(){
    ...
    //creating helper for rect area light
    var rectLightHelper = new THREE.RectAreaHelper(rectAreaLight);
    ...
    //position and lookAt for rect areak light
...
function getRectAreaLight(intensity, width, height){
    ...
    //rect area light doesnot cast shadow
